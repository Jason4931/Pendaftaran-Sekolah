...
if (isset($_POST["email"]) && isset($_POST["password"])) {
  ...
  if (mysqli_num_rows($result)>0) {
    ...
    $_SESSION["ID"]=$row["ID"];
    header('location: /Pendaftaran Sekolah/?menu=home');
  }
  else {
  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-md-8 col-sm-10 col-12 ml-auto">
      <form method="post" class="card p-4 bg-body-secondary shadow-sm mx-4">
        ...
        <h1 class="h3 my-4 text-center">Login</h1>
        ...
        <div class="text-center mt-4">
          ...
          <label><a href="/Pendaftaran Sekolah/?register" style="text-decoration:none">Register</a></label>
        </div>
      </form>
    </div>
    <div class="col-lg-3 col-md-2 col-sm-1 col-0"></div>
